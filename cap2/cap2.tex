...
garnde complicador: estas possuem tamanho exponencial sobre o n\'umero
...
\section{Dedu\c{c}\~ao Natural para L\'ogica Proposicional}

A dedu\c{c}\~ao natural \'e um sistema formal que permite-nos deduzir
consequ\^encias a partir de um conjunto de f\'ormulas. Antes de
apresentarmos este sistema, devemos definir formalmente o que
significa uma f\'ormula ser consequ\^encia de um conjunto de
f\'ormulas.
...
Logo, podemos utilizar tabelas verdade para determinar a validade de
consequ\^encias l\'ogicas. Um inconveniente desta abordagem \'e que,
como j\'a apresentado na Se\c{c}\~ao \ref{limitacao-tabela-verdade}, o
n\'umero de linhas de uma tabela verdade
para uma f\'ormula com $n$ vari\'aveis \'e $2^n$.

Uma alternativa ao uso de tabelas verdade para determinar a validade
de consequ\^encias l\'ogicas \'e a utiliza\c{c}\~ao de
\textit{Dedu\c{c}\~ao Natural}. A dedu\c{c}\~ao natural \'e um sistema
formal que permite o racioc\'inio dedutivo com base no significado dos
conectivos l\'ogicos sem a necessidade de utilizar tabelas verdade ou
avaliar express\~oes l\'ogicas. 
