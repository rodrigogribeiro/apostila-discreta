...
\end{tabular}
\end{flushleft}
A expressão $z\in \bigcup \mathcal{F}$ é representada como $\exists
A. A\in\mathcal{F}\land z \in A$. Isso nos leva a:
\begin{flushleft}
\begin{tabular}{ll}
Hipóteses & Conclusão \\
$B$ é um conjunto & $ y \in B$ \\
$\mathcal{F}$ é uma família. & \\
$\forall z.(\exists A. A\in\mathcal{F}\land z \in A) \to z\in B$ & \\
$x$ arbitrário & \\
$x\in\mathcal{F}$ & \\
$y$ arbitrário & \\
$y\in x$ & \\
